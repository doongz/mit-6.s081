...
![](../images/image%20%28811%29%20%281%29.png)
...
![](../images/image%20%28394%29.png)

但是前面只是定性的评估，下面会介绍一些更具体的例子。当有大量的并发线程，且线程有共享的数据时，GC如何起作用的。

![](../images/image%20%28726%29.png)
...
![](../images/image%20%28824%29.png)

接下来看看CVEs Bugs，这在前面提到过（注，20.1）。

![](../images/image%20%28851%29.png)
...
![](../images/image%20%28815%29.png)

这一页跳过。

# 20.9 Evaluation: HLL performance cost\(2\)

![](../images/image%20%28807%29.png)
