...
![](../images/image%20%28448%29%20%281%29%20%281%29%20%281%29.png)

![](../images/image%20%28567%29.png)

之后在gdb中continue。立刻会停在中断的位置，因为定时器中断还是挺频繁的。现在我们可以确认我们在usertrap函数中，并且usertrap函数通过调用devintr函数来处理这里的中断（注，从下图的栈输出可以看出）。

![](../images/image%20%28491%29.png)
...
![](../images/image%20%28450%29.png)

可以从gdb中看到devintr的确返回的是2。

![](../images/image%20%28533%29.png)
...
![](../images/image%20%28551%29.png)

当前进程是spin程序，如预期一样。

![](../images/image%20%28454%29.png)
...
![](../images/image%20%28501%29.png)

我们可以查看spin.asm文件来确定对应地址的指令。

![](../images/image%20%28575%29.png)
...
![](../images/image%20%28516%29%20%282%29%20%282%29.png)
...
![](../images/image%20%28516%29%20%282%29%20%282%29%20%281%29.png)
